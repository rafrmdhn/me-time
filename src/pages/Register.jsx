    ...
    return (
        <div className='w-full min-h-screen bg-gradient-to-r from-[#91C8E4] to-[#4682A9] flex flex-col justify-center items-center'>
            ...
            <div className='bg-white px-4 py-10 w-full max-w-xl rounded-xl'>
                <h1 className='text-center mb-3 text-2xl'>REGISTER ADMIN</h1>
                ...
                <form action="" >
                    <div className='flex flex-col mb-4 text-left'>
                        ...
                        />
                        <p className='text-sm text-red-500'>emaial has alredy been used</p>
                    </div>
                    <div className='flex flex-col mb-4 text-left'>
                    ...
                    <div className='flex flex-col mb-4 text-left'>
                        <label htmlFor="re_password" className='text-sm'>Re-Password</label>
                        <input 
                            type="password" 
                            name='re_password' 
                            placeholder='********' 
                            className='py-4 px-3 w-full border border-slate-400 outline-none hover:border-slate-500 focus:border-slate-800 rounded'
                        />
                        <p className='text-sm text-red-500'>Password and re password do not match</p>
                    </div>
                    <button 
                        type="submit"
                ...
                <div className='text-center mb-3'>
                    <Link to="/admin-login" className='text-sm text-blue-500'>Alredy an have account</Link>
                </div>
