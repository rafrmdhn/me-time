        ...
        <div className="fixed top-0 right-0 bottom-0 left-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-xl shadow">
                    ...
                    <form class="p-4 md:p-5" onSubmit={BuatDiskusi}>
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="description" rows="4" class="bg-[#F6F4EB] border border-gray-900 text-black text-sm rounded-3xl focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 placeholder-black" placeholder="Write product description here"
                                value={content}
