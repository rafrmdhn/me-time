    ...
    return (
        <div className="relative overflow-x-auto">
            ...
            <div className="flex justify-between items-center w-full relative">
                ...
                <input type="text" id="table-search" className="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Pengguna" 
