...
const Review = ({ onClose }) => {
    ...
    const rateNow = async (e) => {
        try {
            ...
            const response2 = await axios.post('http://195.35.8.190:4000/api/testimoni ', {
            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-xl shadow">
                    ...
                    <div className="w-3/4 flex flex-col m-5 mx-auto w-full">
                        ...
                        <textarea rows="3" value={comment} onChange={(e) => setComment(e.target.value)} className=" m-6 p-4 text-gray-500 rounded-xl resize-none border-gray-900" placeholder="Berikan Review"/>
                        <button onClick={rateNow} className="py-2 mx-20 text-lg bg-violet-600 focus:ring-4 focus:outline-none focus:ring-violet-300 rounded-xl text-white ">
                        Rate now
                        </button>
