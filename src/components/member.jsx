...
const Member = () => {
    return (
        <section class="py-20 bg-[#F6F4EB]">
            <div class="container mx-auto px-6 md:px-12 xl:px-32 flex flex-col">
                <div class="mb-16 text-center">
                    <h2 class="mb-4 text-center text-2xl text-gray-900 font-semibold md:text-4xl">Kenali Tim Pakar Kami</h2>
                    <p class="text-gray-600 lg:w-8/12 lg:mx-auto">Temukan keahlian di balik layanan kami. Tim pakar kami siap memberikan solusi terbaik untuk kebutuhan Anda. Dapatkan pengalaman pelayanan yang unggul dengan para profesional berpengalaman di bidangnya.</p>
                </div>
                <div class="grid gap-12 items-center md:grid-cols-3">
                    ...
                    <div class="space-y-4 text-center">
                        ...
                        <div>
                            <h4 class="text-2xl">Rafi Ramadhan</h4>
